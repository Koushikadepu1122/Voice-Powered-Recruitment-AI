...
export default function Billing() {
  ...
  return (
    ...
    <PayPalScriptProvider
      options={{
        clientId: process.env.NEXT_PUBLIC_PAYPAL_CLIENT_ID , // sandbox "test" is fine for dev
        currency: "USD",
      }}
    >
    <div className="min-h-screen bg-gradient-to-blue from-gray-50 to-gray-100 py-12 px-4 sm:px-6 lg:px-8">
  ...
  {/* Button that opens the PayPal dialog */}
  ...
  {/* Popup like in your screenshot */}
  <DialogContent className="max-w-lg">
  <DialogHeader>
    <DialogTitle>Checkout</DialogTitle>
    <DialogDescription>
      Pay securely with PayPal for {selectedPackage.credits} credits.
    </DialogDescription>
  </DialogHeader>
  ...
  <PayPalButtons
    ...
    onApprove={async (data, actions) => {
      setLoading(true);
      await actions.order.capture();      // PayPal capture
      await handlePurchase();             // your Supabase credit update
      setLoading(false);
      setPaypalOpen(false);
