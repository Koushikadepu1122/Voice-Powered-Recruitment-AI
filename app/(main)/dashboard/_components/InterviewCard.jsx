...
function InterviewCard({interview, viewDetail=false}) {
    ...
    const onSend = () =>{
        window.location.href="mailto:koushikadepu1122@gmail.com ? subject = TalkCruiter Interview Link & body=Interview Link:"+ url
    }

    return(
        <div className='p-5 bg-white rounded-lg border'>
            <div className='flex items-center justify-between'>
                <div className='h-[39px] w-[39px] bg-blue-600 rounded-full'></div>
            ...
            {!viewDetail ? <div className='flex gap-3 w-full mt-5'>
                ...
                onClick={copyLink}> <Copy/> Copy Link</Button>
                <Button className={'w-[165px]'} onClick={onSend}> <Send/> Send</Button>
            </div>
            : 
