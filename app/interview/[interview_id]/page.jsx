...
function Interview() {
    ...
    return(
        <div className='px-10 md:px-28 lg:px-48 xl:px-70 mt-16'>
            <div className='flex flex-col items-center justify-center border rounded-lg bg-white p-7 lg:px-34 xl:px-60 mb-20 '>
                ...
                <div className='w-full'>
                    ...
                    <Input placeholder='eg. dhoni' className='mt-2' 
                    onChange={(event) =>setUserName(event.target.value)}/>
                </div>

                <div className='w-full'>
                    <h2 className='mt-3'>Enter Your Email </h2>
                    <Input placeholder='eg. msdhoni@gmail.com' className='mt-2' 
                ...
                <div className='p-3 bg-blue-100 flex gap-4 rounded-lg mt-4'>
                    ...
                    <div>
                        ...
                        <ul>
                            ...
                            <li className='text-sm text-primary'>- Please make sure you're in a quiet place for the interview</li>
                        </ul>
                    </div>
                </div>
                ...
                onClick={() => onJoinInterview()} ><Video/> 
                {loading && <Loader2Icon/>}Join Interview</Button>
